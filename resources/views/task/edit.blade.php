                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('task.update',$task->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="task_name" type="text"
                                        ...
                                        value="{{ $task->task_name }}" autocomplete="task_name">
                                    ...
                                    <select id="employee_id" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id">
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                @if ($task->employee_id == $employee->id) selected @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="details" type="text" class="form-control @error('details') is-invalid @enderror" name="details">{{ $task->details }}
                                    </textarea>
                                    @error('details')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
